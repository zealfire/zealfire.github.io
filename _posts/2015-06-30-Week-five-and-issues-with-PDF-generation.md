...
The week five of coding period has ended and as planned I started to work on generating pdf using third party libraries after fixing some errors and code style in the module written till now. As expected the week turned out to be very eventful and very exciting for me atleast because I really like the idea of interfacing Drupal with external libraries and tools, mainly because it makes Drupal more useful and easier to use.
